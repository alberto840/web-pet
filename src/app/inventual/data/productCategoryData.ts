export interface ProductCatInterfaceData {
  ...
  export const productCategoryData: ProductCatInterfaceData[] = [
    {
        id: 1,
        name: 'Fish & Meat',
        subCategory: 'Deshi Fish',
        products: 'Katal, Rooi fish, Beef, Deshi chicken, Loitta fish, Breads, Cereals, Rice, Pasta, Noodles',
        action: '',
    },
    {
        id: 2,
    ...
    },
    {
        ...
        products: 'Croissants, Danish Pastries, Scones, Cinnamon Rolls, Éclairs, Muffins, Bagels, Donuts, Biscotti, Turnovers',
        action: '',
    },
    {
        id: 10,
    ...
    },
    {
        ...
        products: 'Shrimp, Lobster, Crab, Mussels, Clams, Oysters, Scallops, Squid, Octopus, Crayfish',
        action: '',
    }
];
