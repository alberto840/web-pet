...
import { UpdateProducto } from 'src/app/inventual/state-management/producto/producto.action';
...
@Component({
  selector: 'app-actualizar-oferta-producto',
  templateUrl: './actualizar-oferta-producto.component.html',
  styleUrls: ['./actualizar-oferta-producto.component.scss'],
        encapsulation: ViewEncapsulation.None
})
export class ActualizarOfertaProductoComponent implements AfterViewInit, OnInit {
