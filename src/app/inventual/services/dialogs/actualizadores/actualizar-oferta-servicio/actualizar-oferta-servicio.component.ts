...
import { getHorarioAtencion, AddHorarioAtencion } from 'src/app/inventual/state-management/horarioAtencion/horarioAtencion.action';
...
import { UpdateServicio } from 'src/app/inventual/state-management/servicio/servicio.action';
...
@Component({
  selector: 'app-actualizar-oferta-servicio',
  templateUrl: './actualizar-oferta-servicio.component.html',
  styleUrls: ['./actualizar-oferta-servicio.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class ActualizarOfertaServicioComponent implements OnInit {
